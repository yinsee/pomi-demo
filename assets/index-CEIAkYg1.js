...
`)+`
`+M);const L=w+y+f,D=w+M+d,k=Sv(l,l.VERTEX_SHADER,L),I=Sv(l,l.FRAGMENT_SHADER,D);l.attachShader(C,k),l.attachShader(C,I),i.index0AttributeName!==void 0?l.bindAttribLocation(C,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(C,0,"position"),l.linkProgram(C);function H(V){if(r.debug.checkShaderErrors){const $=l.getProgramInfoLog(C)||"",at=l.getShaderInfoLog(k)||"",ot=l.getShaderInfoLog(I)||"",nt=$.trim(),z=at.trim(),U=ot.trim();let Z=!0,J=!0;if(l.getProgramParameter(C,l.LINK_STATUS)===!1)if(Z=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(l,C,k,I);else{const ht=Mv(l,k,"vertex"),O=Mv(l,I,"fragment");Ne("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(C,l.VALIDATE_STATUS)+`
